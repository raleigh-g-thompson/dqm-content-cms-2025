...
| Details | Value |
| --- | --- |
| Generated | 2026-09-04 13:39:20.823707 |
| Total Measures | 74 |
| Total Test Cases | 3964 |
| Measures with Discrepancies | 34 |
| Known Issues (resolution pending) | 11 issues / 4 test cases |
| Passing Test Cases (all) | 3659 (92.31%) |
| Failing Test Cases (all) | 305 (7.69%) |
| Passing Test Cases (excl. resolution-pending) | 3659 (92.40%) |
| Failing Test Cases (excl. resolution-pending) | 301 (7.60%) |
...
| CMS69FHIRPCSBMIScreenAndFollowUp | 46 / 17 | 63 / 0 | CMS has discrepancies, QICore passes |
...
| CMS135FHIRACEIorARBorARNIforHF | 28 / 12 | 37 / 3 | Both have discrepancies |
...
| CMS165FHIRControllingHighBP | 65 / 3 | 58 / 10 | Both have discrepancies |
...
| CMS347FHIRStatinPreventionTxCVD | 162 / 26 | 174 / 14 | Both have discrepancies |
...
| CMS1264FHIRECATREHQR | 1 / 57 | 1 / 57 | Both have discrepancies |
...
| [CMS69FHIRPCSBMIScreenAndFollowUp](#cms69fhirpcsbmiscreenandfollowup) | 63 | 0 | 0 | 26.98%   (17) | 63 / 0 | passes |
...
| [CMS135FHIRACEIorARBorARNIforHF](#cms135fhiraceiorarborarniforhf) | 40 | 3 | 0 | 22.50%   (9) | 37 / 3 | has discrepancies (0) |
...
| [CMS165FHIRControllingHighBP](#cms165fhircontrollinghighbp) | 68 | 1 | 0 | 2.94%   (2) | 58 / 10 | has discrepancies (9) |
...
| [CMS347FHIRStatinPreventionTxCVD](#cms347fhirstatinpreventiontxcvd) | 188 | 4 | 0 | 13.30%   (25) | 174 / 14 | has discrepancies (13) |
...
| [CMS1264FHIRECATREHQR](#cms1264fhirecatrehqr) | 58 | 0 | 0 | 98.28%   (57) | 1 / 57 | has discrepancies (57) |
...
Mismatched Test Cases (17 of 63 test cases)
| Test Case | Group | Population | Expected | Actual | Known Issue | QICore |
|---|---|---|:---:|:---:|---|:---:|
...
Mismatched Test Cases (9 of 40 test cases)
| Test Case | Group | Population | Expected | Actual | Known Issue | QICore |
|---|---|---|:---:|:---:|---|:---:|
...
Mismatched Test Cases (2 of 68 test cases)
| Test Case | Group | Population | Expected | Actual | Known Issue | QICore |
|---|---|---|:---:|:---:|---|:---:|
...
Missing Results (4 of 188 test cases)
| Test Case | Group | Known Issue |
| --- | --- | --- |
...
Mismatched Test Cases (25 of 188 test cases)
| Test Case | Group | Population | Expected | Actual | Known Issue | QICore |
|---|---|---|:---:|:---:|---|:---:|
...
QICore: 1 / 57 — has discrepancies (57 mismatched, 0 missing)

Mismatched Test Cases (57 of 58 test cases)
| Test Case | Group | Population | Expected | Actual | Known Issue | QICore |
|---|---|---|:---:|:---:|---|:---:|
...
| CMS69FHIRPCSBMIScreenAndFollowUp | 17 | 0 | 0 |
...
| CMS165FHIRControllingHighBP | 11 | 0 | 0 |
| CMS177FHIRChildMDDSuicideAssmt | 2 | 0 | 0 |
| CMS190FHIRVTEProphylaxisICU | 17 | 0 | 0 |
| CMS347FHIRStatinPreventionTxCVD | 140 | 0 | 0 |
