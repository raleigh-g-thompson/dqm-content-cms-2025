...
| Details | Value |
| --- | --- |
| Generated | 2026-09-04 15:30:54.382775 |
| Total Measures | 74 |
| Total Test Cases | 3964 |
| Measures with Discrepancies | 33 |
| Known Issues (resolution pending) | 11 issues / 4 test cases |
| Passing Test Cases (all) | 3679 (92.81%) |
| Failing Test Cases (all) | 285 (7.19%) |
| Passing Test Cases (excl. resolution-pending) | 3679 (92.90%) |
| Failing Test Cases (excl. resolution-pending) | 281 (7.10%) |
